...
public class AdminPanel extends JFrame implements ActionListener{
		...
		JMenuItem itemAddProduct;
		JMenu mnProduct;
		JMenuItem itemUpdateProduct;
		JMenuItem itemDeleteProduct;
		JMenu mnCashier;
		JMenuItem itemDeleteCashier;
		JMenuItem itemAddCashier;
		JMenu mnStock;
		JMenuItem itemShowStock;
		JMenu mnExport;
		...
		public AdminPanel() {
			...
			itemAddProduct = new JMenuItem("Add Product");
			mnProduct.add(itemAddProduct);
			itemAddProduct.addActionListener(this);
			
			itemUpdateProduct = new JMenuItem("Update Product");
			mnProduct.add(itemUpdateProduct);
			itemUpdateProduct.addActionListener(this);
			
			itemDeleteProduct = new JMenuItem("Delete Product");
			mnProduct.add(itemDeleteProduct);
			itemDeleteProduct.addActionListener(this);
			
			mnCashier = new JMenu("Cashier");
			menuBar.add(mnCashier);
			
			itemAddCashier = new JMenuItem("Add Cashier");
			mnCashier.add(itemAddCashier);
			itemAddCashier.addActionListener(this);
			
			itemDeleteCashier = new JMenuItem("Delete Cashier");
			mnCashier.add(itemDeleteCashier);
			itemDeleteCashier.addActionListener(this);
			
			mnStock = new JMenu("Stock");
			menuBar.add(mnStock);
			
			itemShowStock = new JMenuItem("Show Stock");
			mnStock.add(itemShowStock);
			itemShowStock.addActionListener(this);
